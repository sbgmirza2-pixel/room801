    ...
    <div className="min-h-screen bg-[#202328] text-[#E8E9E7] font-sans flex flex-col">
      ...
      >
        ...
        <div className="space-y-6 text-[#a9b0ba] text-base leading-relaxed">
          ...
          <p>
            Our goal is to keep the information easy to understand. You can
            learn about Room 801, its gameplay, anomalies, endings, and
            installation steps without going through complicated information.
          </p>

          <p>
            We also try to keep our content clear and useful for players who
            are looking for Room 801 APK information. If you have any question
            about our website or its content, you can contact us through our
            Contact Us page.
          </p>
        </div>
      </main>
